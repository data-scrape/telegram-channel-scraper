...
**Telegram Scraper** — Scrape Telegram channels, messages, and subscriber data

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/telegram-channel-scraper?style=social)

</div>

> **Search intent:** collect public Telegram data for research, enrichment, and monitoring workflows. Related topics: telegram channel scraper, channel scraper, web scraping, python, data extraction.

## What this project is for

`telegram-channel-scraper` is an implementation-focused Python project for collecting public Telegram data. It is designed around one practical job: turn a query such as **"restaurants in Seattle"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/telegram-channel-scraper.git
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "Telegram", "category": "Telegram Scrapers"}
  }
}
```
